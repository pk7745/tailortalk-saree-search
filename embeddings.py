"""
Embedding utilities with Dual-Representation Early-Fusion (Whole-Image CLIP + 3D HSV Color Histogram).
"""
...
def get_fused_embedding(image: Image.Image) -> np.ndarray:
    ...
    Uses lossless PNG caching so math is 100% exact (1.0000 self-similarity).
    """
    buf = io.BytesIO()
...
def embedding_dim() -> int:
    """Dimensionality of the fused embedding (512 CLIP + 512 Color = 1024)."""
